...
export async function POST(request: NextRequest): Promise<NextResponse<ApiResponse>> {
  try {
    ...
    // This matches your profilePicStorage params
    const uploadResult = await new Promise((resolve, reject) => {
      cloudinary.uploader.upload_stream(
        {
          resource_type: 'image', // Same as your profilePicStorage
          folder: 'profile_pictures', // Same as your profilePicStorage
          public_id: publicId,
          use_filename: true,
          unique_filename: false,
          overwrite: false,
          // Optional: Add transformations for profile pictures
          transformation: [
    ...
    console.log(`Profile picture uploaded successfully to Cloudinary: ${result.public_id}`);
