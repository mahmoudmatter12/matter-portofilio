      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <div className={`grid ${isMobile ? "grid-cols-1 gap-8" : "md:grid-cols-2 gap-12"}`}>
            ...
            >
              <div>
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">I&apos;d love to hear from you</h3>
            ...
            >
              ...
              <div className="flex border-b border-sky-100 dark:border-gray-700">
                <button
                  ...
                  className={`flex-1 py-4 font-medium flex items-center justify-center gap-2 transition-colors ${contactMethod === "email"
                ...
                <button
                  ...
                  className={`flex-1 py-4 font-medium flex items-center justify-center gap-2 transition-colors ${contactMethod === "whatsapp"
                    ? "text-indigo-600 dark:text-cyan-400 bg-indigo-50/50 dark:bg-gray-700"
                    : "text-gray-600 dark:text-gray-400 hover:bg-gray-50/50 dark:hover:bg-gray-700/30"
                    }`}
                >
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="pt-2">
                        <motion.button
                          ...
                          whileTap={{ scale: 0.98 }}
                          className={`w-full flex items-center justify-center px-6 py-3 rounded-full font-medium text-white bg-gradient-to-r from-indigo-500 to-cyan-400 hover:from-indigo-600 hover:to-cyan-500 transition-all ${isSubmitting ? "opacity-80 cursor-not-allowed" : ""
                            }`}
                        >
                          {isSubmitting ? (
